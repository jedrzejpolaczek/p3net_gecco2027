# Archived report snapshot: R30_budgets-50-100-200-350_2026-08-17T111839_pre-p3net-cleanup

Self-contained frozen copy of `raw/`, `tables/`, and `figures/`, taken 2026-08-17.
...
- 12841 raw runs, 4 table file(s), 195 figure file(s).

## Code state

- Git commit: `1a0c0e3` (uncommitted working-tree changes present at archival time)
