...
def tpe_ask_tell(
    ...
    *,
    ...
    AskTellMethod this feeds -- used here only for read lookups
    (cache.has/cache.get), never record_proposal, so AskTellMethod.propose
    stays the single place that counts proposals (no double-counting)."""
